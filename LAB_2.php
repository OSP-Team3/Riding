...
?><form method="post" action="changepw.php">
            ...
            <div id="myTab">
                <button id="default" class="tab" onclick="openMenu('RecRide', this)">추천 기구</button><button class="tab" onclick="openMenu('RecCourse', this)">스탬프</button><button class="tab" onclick="openMenu2('myReview', this)">작성한 리뷰</button>
...
$sql1 = "SELECT img_link,Ride.ride_id, name FROM Ride, Ride_img WHERE (Ride.ride_id <200 )and (Ride.ride_id= Ride_img.ride_id) and Ride.ride_id NOT IN (SELECT ride_id FROM Review,User where  User.name='$myID' )";


$sql2 = "SELECT Ride_img.ride_id ,img_link FROM Review,Ride_img,User WHERE (Review.ride_id <200)and Review.ride_id=Ride_img.ride_id and User.user_id=Review.user_id and User.name='$myID'" ;
...
$sql1 = "SELECT hash_tag,Ride.name, title,User.user_id,date, Ride.ride_id FROM Review,Ride, User where Ride.ride_id=Review.ride_id and User.name='$myID' and Review.user_id=User.user_id ; ";
...
?>             <tbody>
          ...
          ?>
                                        <span style="background:yellow;"><?php echo $title; }?></span><span class="re_ct"></span></a></td>
                            ...
                            <div align="center" id="search_box">
                                </br>
                                <form action="yy.php" method="get">
                                    ...
                                    <input type="text" name="search" size="40"  /> <button>검색</button>
                                </form>
